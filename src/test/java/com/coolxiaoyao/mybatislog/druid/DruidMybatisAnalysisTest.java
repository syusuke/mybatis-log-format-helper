...
public class DruidMybatisAnalysisTest {


    @Test
    public void fillLogSelect() {
        ...
        List<SqlParamPair> sqlParamPairs = LogResolveHelper.resolveLog(tableNameParams);
        ...
        for (SqlParamPair sqlParamPair : sqlParamPairs) {
            ...
            DruidMybatisAnalysis analysis = new DruidMybatisAnalysis();
            String sql = analysis.analysisRefExpr(sqlParamPair.getSql(), paramItems);
